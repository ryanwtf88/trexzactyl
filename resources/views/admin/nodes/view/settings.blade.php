                ...
                <div class="box">
                    ...
                    <div class="box-body row">
                            ...
                            <div>
                                <select name="location_id" class="form-control">
                                    @foreach($locations as $location)
                                        <option value="{{ $location->id }}" {{ (((int) old('location_id', $node->location_id)) === $location->id) ? 'selected' : '' }}>{{ $location->long }}
                        ...
                        <div class="form-group col-xs-12">
                            ...
                            <div>
                                <input type="radio" name="public" value="1" {{ (old('public', $node->public)) ? 'checked' : '' }} id="public_1" checked> <label for="public_1"
                                    style="padding-left:5px;">Yes</label><br />
                        ...
                        <div class="form-group col-xs-12">
                            ...
                            <div>
                                <input type="text" autocomplete="off" name="deploy_fee" class="form-control"
                                    value="{{ old('deploy_fee', $node->deploy_fee) }}" />
                            </div>
                            <p class="text-muted"><small>Entering a value here means that users deploying a server via the
                                    Storefront must pay a fee in credits to deploy to this node.</small></p>
                        </div>
                        <div class="form-group col-xs-12">
                        ...
                        <div class="form-group col-xs-12">
                            <label class="form-label"><span class="label label-warning"><i class="fa fa-wrench"></i></span>
                    ...
                    <div class="box-body row">
                        <div class="form-group col-xs-12">
                            ...
                            <p class="text-muted"><small>
                                    This option allows you to control whether this node is visible via the Server Creation
                                    page of the Trexzactyl Storefront.
