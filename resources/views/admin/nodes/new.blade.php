        ...
        <div class="col-sm-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="form-label">Deployable via Trexzactyl Store</label>
                        <div>
                            <div class="radio radio-success radio-inline">
                        ...
                        <p class="text-muted"><small>
                            This option allows you to control whether this node is visible via the Server Creation page of the Trexzactyl Storefront.
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="daemonBase" id="pDaemonBase" class="form-control" value="/var/lib/Trexzactyl/volumes" />
