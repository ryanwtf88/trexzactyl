...
@section('content')
    <div class="row">
        <div class="col-xs-12">
            <form action="{{ route('admin.tickets.toggle') }}" method="POST">
                <div class="box @if($enabled == 'true') box-success @else box-danger @endif">
                    <div class="box-header with-border">
                        <i class="fa fa-ticket"></i>
                        <h3 class="box-title">Ticket System <small>Toggle whether tickets can be used.</small></h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted"><small>Determines whether people can create tickets via the client
                                            UI.</small></p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted"><small>Set the maximum amount of tickets a user can
                                            create.</small></p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="text" class="form-control" name="webhook" value="{{ $webhook }}" />
                                    <p class="text-muted"><small>Real-time notifications for your Discord server.</small>
                                    </p>
                                </div>
                            </div>
                        </div>
                        {!! csrf_field() !!}
                        <button type="submit" name="_method" value="POST" class="btn btn-default pull-right">Save
                            Changes</button>
                    </div>
                </div>
            </form>
                        ...
                        <tbody>
                            ...
                            @foreach ($tickets as $ticket)
                                <tr data-ticket="{{ $ticket->id }}">
                                    ...
                                    <td><a
                                            href="{{ route('admin.users.view', $ticket->client_id) }}">{{ $ticket->user->email ?? 'N/A' }}</a>
                                    </td>
                                    <td style="
                                                    white-space: nowrap;
                                                    overflow: hidden;
