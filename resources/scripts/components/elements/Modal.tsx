                ...
                <ModalContainer alignTop={top}>
                    ...
                    {showSpinnerOverlay && (
                        <Fade timeout={150} appear in>
                            <div
                                css={tw`absolute w-full h-full rounded-sm flex items-center justify-center`}
                    ...
                    <div
                        css={tw`bg-neutral-900 bg-opacity-40 backdrop-blur-xl p-3 sm:p-4 md:p-6 rounded-sm shadow-md overflow-y-scroll transition-all duration-150`}
                    >
                        {children}
                    </div>
                </ModalContainer>
