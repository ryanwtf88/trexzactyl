    ...
    return (
        <div
            className={classNames(
                ...
                {
                    ['border-green-500 bg-green-500 bg-opacity-25']: type === 'success',
                    ['border-blue-500 bg-blue-500 bg-opacity-25']: type === 'info',
                    ['border-yellow-500 bg-yellow-500 bg-opacity-25']: type === 'warning',
                    ['border-red-500 bg-red-500 bg-opacity-25']: type === 'danger',
                },
                className
            )}
        >
