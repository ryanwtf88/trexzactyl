...
namespace Trexzactyl\Extensions\Spatie\Fractalistic;
...
use Trexzactyl\Extensions\League\Fractal\Serializers\TrexzactylSerializer;
...
class Fractal extends SpatieFractal
{
    ...
    public function createData(): Scope
    {
        ...
        if (is_null($this->serializer)) {
            $this->serializer = new TrexzactylSerializer();
        }
