...
use Trexzactyl\Exceptions\Http\Server\ServerStateConflictException;

/**
 * \Trexzactyl\Models\Server.
 *
 * @property int $id
 ...
 * @property \Illuminate\Database\Eloquent\Collection|\Trexzactyl\Models\ActivityLog[] $activity
 * @property int|null $activity_count
 * @property \Trexzactyl\Models\Allocation|null $allocation
 * @property \Illuminate\Database\Eloquent\Collection|\Trexzactyl\Models\Allocation[] $allocations
 * @property int|null $allocations_count
 * @property \Illuminate\Database\Eloquent\Collection|\Trexzactyl\Models\Backup[] $backups
 * @property int|null $backups_count
 * @property \Illuminate\Database\Eloquent\Collection|\Trexzactyl\Models\Database[] $databases
 * @property int|null $databases_count
 * @property \Trexzactyl\Models\Egg|null $egg
 * @property \Illuminate\Database\Eloquent\Collection|\Trexzactyl\Models\Mount[] $mounts
 * @property int|null $mounts_count
 * @property \Trexzactyl\Models\Nest $nest
 * @property \Trexzactyl\Models\Node $node
 * @property \Illuminate\Notifications\DatabaseNotificationCollection|\Illuminate\Notifications\DatabaseNotification[] $notifications
 * @property int|null $notifications_count
 * @property \Illuminate\Database\Eloquent\Collection|\Trexzactyl\Models\Schedule[] $schedules
 * @property int|null $schedules_count
 * @property \Illuminate\Database\Eloquent\Collection|\Trexzactyl\Models\Subuser[] $subusers
 * @property int|null $subusers_count
 * @property \Trexzactyl\Models\ServerTransfer|null $transfer
 * @property \Trexzactyl\Models\User $user
 * @property \Illuminate\Database\Eloquent\Collection|\Trexzactyl\Models\EggVariable[] $variables
...
class Server extends Model
{
     ...
     *
     * @throws \Trexzactyl\Exceptions\Http\Server\ServerStateConflictException
     */
