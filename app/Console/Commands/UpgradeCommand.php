...
namespace Trexzactyl\Console\Commands;

use Trexzactyl\Console\Kernel;
...
{
    protected const DEFAULT_URL = 'https://github.com/Trexzactyl/Trexzactyl/releases/%s/panel.tar.gz';
    ...
    protected $description = 'Downloads a new archive from Trexzactyl\'s GitHub and executes the upgrade commands.';

    /**
     * Executes an upgrade command which will run through all of our standard
     * commands for Trexzactyl and enable users to basically just download
    ...
    public function handle()
    {
        ...
        /** @var \Trexzactyl\Console\Kernel $kernel */
