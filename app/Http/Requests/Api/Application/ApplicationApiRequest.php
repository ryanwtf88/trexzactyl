...
namespace Trexzactyl\Http\Requests\Api\Application;
...
abstract class ApplicationApiRequest extends FormRequest
{
     ...
     *
     * @throws \Trexzactyl\Exceptions\TrexzactylException
     */
    public function authorize(): bool
    {
        if (is_null($this->resource)) {
            throw new TrexzactylException('An ACL resource must be defined on API requests.');
        }
