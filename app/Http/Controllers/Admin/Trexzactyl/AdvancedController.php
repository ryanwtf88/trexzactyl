...
use Trexzactyl\Http\Requests\Admin\Trexzactyl\AdvancedFormRequest;
...
class AdvancedController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return $this->view->make('admin.trexzactyl.advanced', [
            'warning' => $warning,
    ...
    public function update(AdvancedFormRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.trexzactyl.advanced');
    }
}
