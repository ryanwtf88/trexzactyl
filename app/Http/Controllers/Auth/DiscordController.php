    ...
    public function callback(Request $request)
    {
        ...
        if (User::where('discord_id', $discord->id)->exists()) {
            ...
            $data = [
                ...
                'store_cpu' => $this->settings->get('Trexzactyl::registration:cpu', 0),
                'store_memory' => $this->settings->get('Trexzactyl::registration:memory', 0),
                'store_disk' => $this->settings->get('Trexzactyl::registration:disk', 0),
                'store_slots' => $this->settings->get('Trexzactyl::registration:slot', 0),
                'store_ports' => $this->settings->get('Trexzactyl::registration:port', 0),
                'store_backups' => $this->settings->get('Trexzactyl::registration:backup', 0),
                'store_databases' => $this->settings->get('Trexzactyl::registration:database', 0),
            ];
