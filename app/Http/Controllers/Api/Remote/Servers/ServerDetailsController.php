...
use Trexzactyl\Services\Eggs\EggConfigurationService;
use Trexzactyl\Repositories\Eloquent\ServerRepository;
use Trexzactyl\Http\Resources\Wings\ServerConfigurationCollection;
    ...
    public function resetState(Request $request): JsonResponse
    {
        ...
        $this->connection->transaction(function () use ($node, $servers) {
            ...
            foreach ($servers as $server) {
                /** @var \Trexzactyl\Models\ActivityLog|null $activity */
