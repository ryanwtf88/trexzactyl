...
namespace Trexzactyl\Http\Controllers\Api\Remote;
...
use Trexzactyl\Models\ActivityLogSubject;
use Trexzactyl\Http\Controllers\Controller;
use Trexzactyl\Http\Requests\Api\Remote\ActivityEventRequest;
...
class ActivityProcessingController extends Controller
{
    public function __invoke(ActivityEventRequest $request)
    {
        ...
        /** @var \Trexzactyl\Models\Node $node */
        ...
        foreach ($request->input('data') as $datum) {
            /** @var \Trexzactyl\Models\Server|null $server */
