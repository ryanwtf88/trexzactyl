...
use Trexzactyl\Services\Referrals\UseReferralService;
use Trexzactyl\Http\Requests\Api\Client\ClientApiRequest;
use Trexzactyl\Transformers\Api\Client\Referrals\ReferralCodeTransformer;
use Trexzactyl\Transformers\Api\Client\Referrals\ReferralActivityTransformer;
...
class ReferralsController extends ClientApiController
{
    ...
    {
        /** @var \Trexzactyl\Models\ReferralCode $code */
