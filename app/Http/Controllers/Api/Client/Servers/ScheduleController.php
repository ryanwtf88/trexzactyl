...
use Trexzactyl\Services\Schedules\ProcessScheduleService;
use Trexzactyl\Transformers\Api\Client\ScheduleTransformer;
use Trexzactyl\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Trexzactyl\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use Trexzactyl\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use Trexzactyl\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use Trexzactyl\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use Trexzactyl\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    {
        /** @var \Trexzactyl\Models\Schedule $model */
