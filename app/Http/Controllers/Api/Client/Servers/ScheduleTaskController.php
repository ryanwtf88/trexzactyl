...
use Trexzactyl\Exceptions\Http\HttpForbiddenException;
use Trexzactyl\Transformers\Api\Client\TaskTransformer;
use Trexzactyl\Http\Requests\Api\Client\ClientApiRequest;
use Trexzactyl\Http\Controllers\Api\Client\ClientApiController;
use Trexzactyl\Exceptions\Service\ServiceLimitExceededException;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Trexzactyl\Http\Requests\Api\Client\Servers\Schedules\StoreTaskRequest;
...
class ScheduleTaskController extends ClientApiController
{
     ...
     * @throws \Trexzactyl\Exceptions\Service\ServiceLimitExceededException
     */
    public function store(StoreTaskRequest $request, Server $server, Schedule $schedule): array
    {
        $limit = config('Trexzactyl.client_features.schedules.per_schedule_task_limit', 10);
        ...
        /** @var \Trexzactyl\Models\Task|null $lastTask */
        $lastTask = $schedule->tasks()->orderByDesc('sequence_id')->first();

        /** @var \Trexzactyl\Models\Task $task */
