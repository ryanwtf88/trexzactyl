...
use Trexzactyl\Services\Subusers\SubuserCreationService;
use Trexzactyl\Repositories\Wings\DaemonServerRepository;
use Trexzactyl\Transformers\Api\Client\SubuserTransformer;
...
use Trexzactyl\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use Trexzactyl\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use Trexzactyl\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use Trexzactyl\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
     ...
     * @throws \Trexzactyl\Exceptions\Service\Subuser\ServerSubuserExistsException
     * @throws \Trexzactyl\Exceptions\Service\Subuser\UserIsServerOwnerException
     * @throws \Throwable
     */
    ...
    {
        /** @var \Trexzactyl\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
