...
use Trexzactyl\Notifications\VerifyEmail;
use Trexzactyl\Exceptions\DisplayException;
use Trexzactyl\Services\Users\UserUpdateService;
use Trexzactyl\Transformers\Api\Client\AccountTransformer;
use Trexzactyl\Http\Requests\Api\Client\Account\UpdateEmailRequest;
use Trexzactyl\Http\Requests\Api\Client\Account\UpdatePasswordRequest;
use Trexzactyl\Http\Requests\Api\Client\Account\UpdateUsernameRequest;
...
class AccountController extends ClientApiController
{
    ...
    {
        $token = $this->genStr();
        $name = $this->settings->get('settings::app:name', 'Trexzactyl');
