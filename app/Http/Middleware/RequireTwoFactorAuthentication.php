...
namespace Trexzactyl\Http\Middleware;

use Illuminate\Support\Str;
use Illuminate\Http\Request;
use Prologue\Alerts\AlertsMessageBag;
use Trexzactyl\Exceptions\Http\TwoFactorAuthRequiredException;
...
class RequireTwoFactorAuthentication
{
     ...
     *
     * @throws \Trexzactyl\Exceptions\Http\TwoFactorAuthRequiredException
     */
    public function handle(Request $request, \Closure $next): mixed
    {
        ...
        $level = (int) config('Trexzactyl.auth.2fa_required');
