...
namespace Trexzactyl\Services\Backups;
...
use Trexzactyl\Extensions\Backups\BackupManager;
use Trexzactyl\Repositories\Eloquent\BackupRepository;
use Trexzactyl\Repositories\Wings\DaemonBackupRepository;
use Trexzactyl\Exceptions\Service\Backup\TooManyBackupsException;
...
class InitiateBackupService
{
     ...
     *
     * @throws \Throwable
     * @throws \Trexzactyl\Exceptions\Service\Backup\TooManyBackupsException
    ...
    public function handle(Server $server, string $name = null, bool $override = false): Backup
    {
        ...
        if (!$server->backup_limit || $successful->count() >= $server->backup_limit) {
            ...
            /** @var \Trexzactyl\Models\Backup $oldest */
        ...
        return $this->connection->transaction(function () use ($server, $name) {
            /** @var \Trexzactyl\Models\Backup $backup */
