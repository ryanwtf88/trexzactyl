...
namespace Trexzactyl\Services\Databases;

use Exception;
use Trexzactyl\Models\Server;
use Trexzactyl\Models\Database;
use Trexzactyl\Helpers\Utilities;
use Illuminate\Database\ConnectionInterface;
use Illuminate\Contracts\Encryption\Encrypter;
use Trexzactyl\Extensions\DynamicDatabaseConnection;
use Trexzactyl\Repositories\Eloquent\DatabaseRepository;
use Trexzactyl\Exceptions\Repository\DuplicateDatabaseNameException;
use Trexzactyl\Exceptions\Service\Database\TooManyDatabasesException;
use Trexzactyl\Exceptions\Service\Database\DatabaseClientFeatureNotEnabledException;
...
class DatabaseManagementService
{
     ...
     *
     * @see \Trexzactyl\Services\Databases\DatabaseManagementService::generateUniqueDatabaseName()
     */
     ...
     *
     * @throws \Throwable
     * @throws \Trexzactyl\Exceptions\Service\Database\TooManyDatabasesException
     * @throws \Trexzactyl\Exceptions\Service\Database\DatabaseClientFeatureNotEnabledException
     */
     ...
     *
     * @throws \Trexzactyl\Exceptions\Repository\DuplicateDatabaseNameException
     * @throws \Throwable
     */
