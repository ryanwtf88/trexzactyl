...
return [
    ...
    */
    ...
    | standard Trexzactyl shipped services.
    */
    ...
    */
    ...
    'cdn' => [
        'cache_time' => 60,
        'url' => 'https://versions.Trexzactyl.com',
    ],
    ...
    */
    ...
    'client_features' => [
        'databases' => [
            'enabled' => env('Trexzactyl_CLIENT_DATABASES_ENABLED', true),
            'allow_random' => env('Trexzactyl_CLIENT_DATABASES_ALLOW_RANDOM', true),
        ],

        'schedules' => [
            // The total number of tasks that can exist for any given schedule at once.
            'per_schedule_task_limit' => env('Trexzactyl_PER_SCHEDULE_TASK_LIMIT', 10),
        ],

        'allocations' => [
            'enabled' => env('Trexzactyl_CLIENT_ALLOCATIONS_ENABLED', true),
            'range_start' => env('Trexzactyl_CLIENT_ALLOCATIONS_RANGE_START'),
            'range_end' => env('Trexzactyl_CLIENT_ALLOCATIONS_RANGE_END'),
        ],
    ],
    ...
    */
    ...
    'files' => [
        'max_edit_size' => env('Trexzactyl_FILES_MAX_EDIT_SIZE', 1024 * 1024 * 4),
    ],
    ...
    */
    ...
    'assets' => [
        'use_hash' => env('Trexzactyl_USE_ASSET_HASH', false),
    ],
    ...
    */
    ...
    'email' => [
        ...
        'send_install_notification' => env('Trexzactyl_SEND_INSTALL_NOTIFICATION', true),
