...
use Trexzactyl\Contracts\Repository\DaemonKeyRepositoryInterface;
    ...
    public function up()
    {
        ...
        $servers->each(function ($server) use (&$inserts) {
            $inserts[] = [
                ...
                'expires_at' => Carbon::now()->addMinutes(config('Trexzactyl.api.key_expire_time', 720))->toDateTimeString(),
