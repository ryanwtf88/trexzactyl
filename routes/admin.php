...
use Trexzactyl\Http\Controllers\Admin;
use Illuminate\Support\Facades\Route;
use Trexzactyl\Http\Controllers\Admin\Trexzactyl;
use Trexzactyl\Http\Middleware\Admin\Servers\ServerInstalled;
...
Route::group(['prefix' => '/'], function () {
    ...
    Route::group(['prefix' => '/approvals'], function () {
        ...
        Route::post('/approve/{id}', [Trexzactyl\ApprovalsController::class, 'approve'])->name('admin.trexzactyl.approvals.approve');
    });
    ...
    Route::group(['prefix' => '/upgrade'], function () {
        Route::get('/', [Trexzactyl\UpgradeController::class, 'index'])->name('admin.trexzactyl.upgrade');
    });
});
